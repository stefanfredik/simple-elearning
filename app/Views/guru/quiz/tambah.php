...
<div class="row modal fade" id="tambahquiz" tabindex="-1" aria-labelledby="tambahquiz" aria-hidden="true">
    <div class="col-12 modal-dialog">
        <div class="modal-content">
            ...
            <!-- <form action="/guru/quiz/tambah" method="POST"> -->
            <?= form_open_multipart('guru/quiz/tambah'); ?>
